...
@section('contenido')
    <div class="container mx-auto flex">
      <div class="md:w-1/2 m-8">
        <img src="{{asset('uploads').'/'. $post->imagen}}" alt="imagen del post{{$post->titulo}}" class="sm:w-100">
        <div class="p-3 flex items-center gap-2">
          ...
          @endauth
            <p class="font-bold" >{{$post->likes->count()}}
              <span class="font-bold">likes</span></p>
        </div>
        <div>
      ...
      <div class="md:w-1/2 rounded-lg m-8">
        <div class="shadow bg-white p-5 mb-4">
            @auth
            <p class="text-xl font-bold text-center mb-4">Agrega tu comentario</p>
            @if (session('mensaje'))
